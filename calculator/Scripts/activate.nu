...
let virtual-env = "C:\Program Files (x86)\PycharmProjects\calculator"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Program Files (x86)\PycharmProjects\calculator\Scripts\deactivate.nu"
